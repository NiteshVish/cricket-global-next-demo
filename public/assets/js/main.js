(function($) {
    ...
    function loader() {
        ...
        console.log("Preloader element found, setting up load event");
        
        // Use multiple methods to ensure the load event fires
        $(window).on('load', function() {
            console.log("Window load event fired");
            console.log("Preloader element before adding loaded class:", $(".preloader")[0]);
            $(".preloader").addClass('loaded');
            console.log("Preloader element after adding loaded class:", $(".preloader")[0]);
